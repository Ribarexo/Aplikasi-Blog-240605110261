        ...
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if($errors->has('gagal')): ?>
                            <div class="alert alert-danger alert-dismissible fade show py-2 small" role="alert">
                                <?php echo e($errors->first('gagal')); ?>
                        ...
                        <form action="<?php echo e(route('login.proses')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="user_name" name="user_name" value="<?php echo e(old('user_name')); ?>" placeholder="Masukkan username" autofocus required>
                            </div>
                            <div class="mb-4">
...
</html><?php /**PATH C:\xampp\htdocs\aplikasi-blog\resources\views/login/index.blade.php ENDPATH**/ ?>